...
let ws1 = new WebService("webcv-dev","dev.burban.me", "registry.gitlab.com/privateprojectsbu/webcv", "v1.2.2-rc.2", keelAnnotationsDev, basicAuthAnnotation);
let ws2 = new WebService("webcv-prod", "burban.me",  "registry.gitlab.com/privateprojectsbu/webcv", "v1.1.2", keelAnnotationsProd,{});
let ws3 = new WebService("webcv-experimental", "experimental.burban.me","registry.gitlab.com/privateprojectsbu/webcv","feature-next", keelAnnotationsExp, basicAuthAnnotation);
